...
?>
                                        <li class="nav-item"><a href="new_orders.php" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-bell-o" aria-hidden="true"></i><span class="indicator-nt"></span></a>
...
{ 
  ...
  ?>
                                                ...
                                                <div class="notification-view">
                                                    <a href="all_orders.php">View All Notification</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="nav-item">
