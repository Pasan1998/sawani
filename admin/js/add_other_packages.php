...
$sql="Insert into tblotherfunc(PackageName,PackageFee,PackageDiliveryTime,PackageDetails)Values(:packname,:packfee,:packdilitime,:packdetail)";
...
<head>
    ...
    <title>Add Other Packages | Memory Click</title>
