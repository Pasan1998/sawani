...
$sql="Insert into tblwedding(PackageName,PackageFee,PackageDiliveryTime,PackageDetails)Values(:packname,:packfee,:packdilitime,:packdetail)";
...
$query->execute();
        ...
        echo '<script>alert("Package Details has been Inserted")</script>';
         echo "<script>window.location.href ='add_wed_packages.php'</script>";
...
<head>
    ...
    <title>Add Wedding Packages | Memory Click</title>
