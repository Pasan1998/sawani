...
if (strlen($_SESSION['obcsuid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
    $add=$_POST['add'];
  $sql="update tbluser set FirstName=:fname,LastName=:lname,MobileNumber=:mobno,Email=:email,Address=:add where ID=:uid";
...
<head>
    ...
    <title>Profile | Memory Click</title>
...
{               ?>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" readonly="true" value="<?php  echo $row->UserName;?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="mobno" value="<?php  echo $row->MobileNumber;?>" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
